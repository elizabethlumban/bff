...
const service = new RulesService_1.RulesService();
    ...
    describe("patch course rules", () => {
        ...
        test("Update rules object based on Points Constraint UI obj", async () => {
            ...
            const uiObj = {
                ...
                ruleType: rule_1.RuleComponentType.PointsConstraint,
        ...
        test("Update Subject Set rule", async () => {
            ...
            expect(ruleTemplate.selectedOrDefaultFormat).toEqual(uiObj.selectedOrDefaultFormat ? uiObj.selectedOrDefaultFormat : "Labelled");
        ...
        test("Delete two level rules object Information UI", async () => {
            ...
            const childIds = ruleGroup.children.map((child) => child.id);
        ...
        test("Add Information rule and template", async () => {
            ...
            const uiObj = {
                ...
                parameters: {
                    text: "There are compulsory requirements at each level, a compulsory quantitative requirement, and requirements for majoring in a commerce discipline.",
                    selfEvaluated: "True"
                },
                selectedOrDefaultFormat: "Heading1"
            };
            const infoRuleTemplate = exampleTemplates.templates.filter((template) => template.type === "Information")[0];
            const recordId = "COU001";
            const result = service.createRuleObj(uiObj, infoRuleTemplate, ruleObj, {
                recordId: "123",
                year: "2020"
            });
            ...
            expect(parameters).toEqual([
                {
                    name: "text",
                    label: "Text",
                    value: "There are compulsory requirements at each level, a compulsory quantitative requirement, and requirements for majoring in a commerce discipline.",
                    type: "string"
                },
                {
                    name: "selfEvaluated",
...
const exampleRuleObject = {
    ...
    formats: constants_1.DEFAULT_FORMATS_ARRAY,
    selectedOrDefaultFormat: constants_1.DEFAULT_FORMAT,
    children: [
        {
            id: "section_1",
                    ...
                    children: [
                        {
                            ...
                            stereotype: rule_1.Stereotype.RuleTemplate,
                            type: rule_1.RuleTemplateType.PointsConstraint,
                            tags: [],
                            selectedOrDefaultFormat: constants_1.DEFAULT_FORMAT,
                            formats: [
                                {
                                    ...
                                    transforms: [
                                        {
                                            ...
                                            type: "text",
                                            outputField: "text",
                                            template: "<p>{{{results (root 0) 'output'}}} of {{{results (child (root 0) 0) 'output'}}}.</p>"
                                        }
                                    ]
                                },
                                {
                                    ...
                                    transforms: [
                                        {
                                            ...
                                            type: "text",
                                            outputField: "text",
                                            template: "{{results 0 'output' 'Basic'}} from the following list of subjects: {{results 1 'output' 'List'}}"
                                        }
                                    ]
                                }
                            ],
                            children: [
                                {
                                    ...
                                    type: rule_1.RuleComponentType.PointsConstraint,
                                    stereotype: rule_1.Stereotype.RuleComponent,
                                    tags: [],
                                    children: [
                                        {
                                                    ...
                                                    transforms: [
                                                        {
                                                            ...
                                                            type: "text",
                                                            outputField: "output",
                                                            template: "{{#each input.staticSubjectReferences}} {{this}}{{#unless @last}},{{/unless}}{{/each}}"
                                                        }
                                                    ]
                                                },
                                                {
            ...
            components: [
                {
                    ...
                    is_legacy: "true",
                    display_order: "1",
                    api_url: "https://unimelbtest.service-now.com/api/x_univ6_as_00001/v1/caps/years/2020/components/B-ARTS_MINOR_1",
                ...
                },
                {
                    ...
                    is_legacy: "true",
                    display_order: "3",
                    api_url: "https://unimelbtest.service-now.com/api/x_univ6_as_00001/v1/caps/years/2020/components/B-ARTS_MINOR_8",
                    learning_outcome_preface: "",
                    learning_outcome_format: "Numbered List with Headings",
                            ...
                            transforms: [
                                {
                                    ...
                                    type: "text",
                                    outputField: "text",
                                    template: "The {{#if plan}}{{plan.course.name}}{{else}}{{context.courseName}}{{/if}} requires the successful completion of {{input.minimum}} points"
                                }
                            ]
                        }
                    ],
                    ...
                    transforms: [
                        {
                            ...
                            type: "html",
                            outputField: "html",
                            template: "<html><body><p>{{results (root 0) 'output' 'Basic'}} of {{results (root 1) 'output' ''}}</p></body></html>"
                        }
                    ]
                },
                {
                    ...
                    transforms: [
                        {
                            ...
                            type: "html",
                            outputField: "html",
                            template: "<html><body><p>{{results (root 0) 'output' 'Basic'}} from the following list of subjects: {{results (root 1) 'output' 'List'}}</p></body></html>"
                        }
                    ]
                }
            ],
                            ...
                            transforms: [
                                {
                                    ...
                                    type: "text",
                                    outputField: "main",
                                    template: "{{#if (eq input.minimum input.maximum)}}You must complete {{input.minimum}} points{{else}}You must complete {{#if input.minimum}}a minimum of {{input.minimum}} points{{/if}}{{#if input.minimum}}{{#if input.maximum}} and {{/if}}{{/if}}{{#if input.maximum}}a maximum of {{input.maximum}} points{{/if}}{{/if}}"
                                },
                                {
                                    stage: 1,
                                    type: "text",
                            ...
                            transforms: [
                                {
                                    ...
                                    type: "text",
                                    outputField: "english",
                                    template: "The {{context.courseName}} requires the successful completion of {{input.minimum}} points"
                                }
                            ]
                        },
                        {
                            ...
                            transforms: [
                                {
                                    ...
                                    type: "text",
                                    outputField: "output",
                                    template: "{{#each staticSubjectReferences}} {{this}}{{#unless @last}},{{/unless}}{{/each}}"
                                }
                            ]
                        },
                        {
...
//# sourceMappingURL=RulesService.test.js.map